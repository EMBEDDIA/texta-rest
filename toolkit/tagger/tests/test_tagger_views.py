...
class TaggerViewTests(APITransactionTestCase):
    ...
    def setUp(self):
        ...
        self._run_create_tagger_training_and_task_signal()
    ...
    def _run_create_tagger_training_and_task_signal(self):
    ...
    def test_create_tagger_with_incorrect_fields(self):
    ...
    def test_tagger_then_delete_tagger_and_created_model(self):
    ...
    def test_tagger_with_empty_fields(self):
    ...
    def test_tag_text_with_lemmatization(self):
        """Tests the endpoint for the tag_text action"""
        payload = {
    ...
    def test_tag_doc_with_lemmatization(self):
        """Tests the endpoint for the tag_doc action"""
        payload = {
    ...
    def test_stop_word_replace(self):
        for test_tagger_id in self.test_tagger_ids:
    ...
    def test_model_export_import(self):
        ...
        self.test_tagger_ids.append(imported_tagger_id)
        print_output('test_import_model:response.data', response.data)
        self.test_tag_text()


    def test_tag_and_feedback_and_retrain(self):
