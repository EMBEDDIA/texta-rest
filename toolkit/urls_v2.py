...
from toolkit.elastic.search_tagger.views import SearchTaggerQueryViewSet, SearchTaggerFieldsViewSet
...
project_router.register('elastic/search_tagger_query', SearchTaggerQueryViewSet, basename='search_tagger_query')
project_router.register('elastic/search_tagger_fields', SearchTaggerFieldsViewSet, basename='search_tagger_fields')
